...
namespace DiffPlex.Avalonia.Controls
{
    internal static class Helper
    {
        ...
        /// </summary>
        internal static void RenderInlineDiffs(InternalLinesViewer viewer, DiffPaneModel m, Control source)
        {
            viewer.Clear();
        ...
        //internal static void InsertLines(InternalLinesViewer panel, List<DiffPiece> lines, bool isOld, Control source)
        //{
        ...
        private static void InsertLinesInteral(InternalLinesViewer panel, List<DiffPiece> lines, bool isOld, Control source, bool disableSubPieces = false)
        {
